...
# Decide where the content is on a page:

# the 1 div with the most words in it
# - that is furthest away from <body> tag

def chooseContentInHTML():
    pass
